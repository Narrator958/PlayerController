...
public class PlayerController : MonoBehaviour {
    ...
    [Header("Input")]
    public InputActionReference inputRef_Movement;     // Action Type: Value  | Vector 2
    public InputActionReference inputRef_Jump;         // Action Type: Button | No interactions
    public InputActionReference inputRef_Sprint;       // Action Type: Button | No interactions
    ...
    public void Update() {
        ...
        Vector2 movement = inputRef_Movement.action.ReadValue<Vector2>();
